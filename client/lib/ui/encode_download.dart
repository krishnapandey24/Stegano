...
class EncodeDownload extends StatelessWidget {
  final bool isWeb;
  final Function(Uint8List) setState;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text("Don't forget to download your image. It will be discarded automatically",style: TextStyle(fontSize: 12,color: Colors.grey),)
        ],
      ),
    );
  }
